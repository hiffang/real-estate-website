...
export default function CreateListing() {
  ...
  const [contactNumber, setContactNumber] = useState(currentUser.number || '');
  ...
  <div className='flex items-center gap-2'>
    ...
    <p>Beds per room</p>
      ...
      <button
        ...
        className={`p-3 flex flex-col bg-slate-700 text-white rounded-lg uppercase hover:opacity-95 mx-auto mb-3 mt-4 max-w-fit`}
